...
it('renders every operator state with its exact action set', async () => {
  ...
  const row1 = (await screen.findByText('0x1111111111111111111111111111111111111111')).closest('tr')!
  ...
  const row2 = screen.getByText('0x2222222222222222222222222222222222222222').closest('tr')!
  ...
  const row3 = screen.getByText('0x3333333333333333333333333333333333333333').closest('tr')!
  ...
  const row4 = screen.getByText('0x4444444444444444444444444444444444444444').closest('tr')!
  ...
  const row5 = screen.getByText('0x5555555555555555555555555555555555555555').closest('tr')!
...
it('shows the 409 message inline when enabling an unregistered operator', async () => {
  ...
  renderPage()
  const row = (await screen.findByText('0x2222222222222222222222222222222222222222')).closest('tr')!
...
it('clears a stale row error once a different row succeeds', async () => {
  ...
  renderPage()
  const row2 = (await screen.findByText('0x2222222222222222222222222222222222222222')).closest('tr')!
...
it('withdraws the full balance by calling operatorWithdraw with "all"', async () => {
  ...
  renderPage()
  const row = (await screen.findByText('0x3333333333333333333333333333333333333333')).closest('tr')!
